...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 221.0, 397.0, 108.0, 22.0 ],
					"text" : "scale~ -1. 1. 5. 10."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 221.0, 351.0, 70.0, 22.0 ],
					"text" : "cycle~ 0.25"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 541.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 25.0, 277.0, 29.0, 22.0 ],
					"text" : "thru"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 25.0, 448.0, 44.0, 64.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 58.0, 351.0, 40.0, 22.0 ],
					"text" : "*~ 0.9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 125.0, 397.0, 66.0, 22.0 ],
					"text" : "tapout~ 20"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 125.0, 351.0, 65.0, 22.0 ],
					"text" : "tapin~ 100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 131.5, 134.0, 59.0, 59.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 111.0, 136.0, 81.0, 22.0 ],
									"text" : "loadmess -12"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 111.0, 174.0, 39.0, 22.0 ],
									"text" : "dbtoa"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 61.0, 174.0, 29.5, 22.0 ],
									"text" : "*~"
								}
...
,
					"patching_rect" : [ 131.5, 209.0, 77.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 25.0, 134.0, 59.0, 59.0 ]
				}
...
,
					"patching_rect" : [ 25.0, 209.0, 59.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 252.0, 134.0, 60.0, 60.0 ]
				}
...
,
					"patching_rect" : [ 252.0, 209.0, 77.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 542.0, 12.0, 313.0, 333.728476821192032 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 55.0, 488.0, 57.0 ],
					"text" : "A phasor is a delayed signal combined with an original signal with a very small delay time that is changing at a decent rate, here the delay~ object is finally useful."
				}
